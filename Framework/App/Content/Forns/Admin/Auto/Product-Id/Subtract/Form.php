...
<form class="InputForm" method="post" action="http://127.0.0.1/Home-Server-Website/Framework/App/Content/Forns/Admin/Auto/Response/Subtract/Subtract.php" enctype='multipart/form-data'>
    <p>Item:</p>
    <?php
